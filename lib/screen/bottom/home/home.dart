...
class _HomeState extends State<Home> {
  ...
  Padding selectVideoSizeSlider() {
    return Padding(
        padding:
            EdgeInsets.only(left: 25.w, right: 25.w, top: 20.h, bottom: 30.h),
        child: const SelectVideoSizeSlider());
  }

  Padding videoSizeText() {
    return Padding(
  ...
  Padding selectVideoStyleSlider() {
    return Padding(
        padding: EdgeInsets.only(top: 20.h),
        child: const SelectVideoStyleSlider());
  }

  Padding selectStyleSection(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(top: 30.h, left: 25.w, right: 25.w),
      child: Row(
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          GradientText(
            'PromAD',
            style: TextStyle(fontSize: 20.sp, fontFamily: "Nexa_Regular"),
            colors: const [
              Color.fromARGB(255, 186, 255, 217),
              Color.fromARGB(255, 150, 255, 255),
              Color(0xFF00FFFF),
